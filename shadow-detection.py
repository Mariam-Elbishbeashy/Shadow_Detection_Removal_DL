...
def predict_and_show(image_path):
    ...
    overlay_img = Image.fromarray(cv2.cvtColor(overlay_result, cv2.COLOR_BGR2RGB))
    overlay_img.show()
...
Button(root, text="Train & Predict", command=train_and_predict, padx=10, pady=5).grid(row=0, column=1, padx=10)
